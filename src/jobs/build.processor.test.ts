...
import { PrismaClient, BuildStatus, Build } from '../generated/prisma/index.js'; // Import Prisma types
import { UniversalConfigurationPackageFormatV1 } from '../core/domain/configuration-package.types.js';
import { ExecutionEngineService, ExecutionResult } from '../infrastructure/execution/execution.service.js'; // Use class directly
...
describe('processBuildJob', () => {
    ...
    beforeEach(async () => {
        ...
        const { processBuildJob: importedFunc } = await import('./build.processor.js');
